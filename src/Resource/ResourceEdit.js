    ...
    return (<div style={{marginTop:'90px'}} id ="main">
        ...
        <div>
            ...
            <div>
                ...
                <input style={{marginLeft:8}}  type="number" name="resource_rent"  value={inputs.resource_rent || ""} onChange={handleChange} required />
            </div>
            <div>
            ...
            <div>
                <label>Picture :</label>
                <input style={{marginLeft:66}} type="text" name="picture"  value={inputs.picture  || ""} onChange={handleChange}  required />
            </div>
            <div>
                <label>Description :</label>
                <textarea style={{marginLeft:35,resize:'none'}} name="description"  value={inputs.description  || ""} onChange={handleChange}  required />
            </div>
